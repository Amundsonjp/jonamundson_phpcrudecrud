...
<body>
<h2>Database Query for last name "Zucker"</h2>
<br>
This query is showing results of all employees with the last name of Zucker.
<br>
<br>
<?php

//this is the php object oriented style of creating a mysql connection
$conn = new mysqli('localhost', 'jamund', 'jamund4', 'employees' );
...
$sql = "SELECT first_name,last_name,hire_date FROM employees where last_name = 'Zucker'";
